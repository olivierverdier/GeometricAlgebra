...
# coq_makefile Aux.v Field.v Grassmann.v Kn.v VectorSpace.v 
#
...
.merlin:
	...
	@echo "B /Users/olivier/Dropbox/coq/GeometricAlgebra" >> .merlin
	@echo "S /Users/olivier/Dropbox/coq/GeometricAlgebra" >> .merlin
